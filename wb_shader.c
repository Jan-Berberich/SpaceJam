...
void wbShaderInit(WBShader* shader) {
    ...
    static const char* fragment_shader_src =
        ...
        "                floor(replaceColorSpeed * frameCounter)) / replaceColorHeight, replaceColorCnt));"
        ...
        "        float flicker = 0.4 * sin(200.0 * pixel.x + 300.0 * pixel.y + 30.0 * deltaTime * frameCounter)"
        "                      + 0.2 * sin(150.0 * pixel.x - 100.0 * pixel.y - 10.0 * deltaTime * frameCounter)"
        "                      + 0.3 * sin(-50.0 * pixel.x -  30.0 * pixel.y +  5.0 * deltaTime * frameCounter)"
        "                      - 0.5 * sin(-30.0 * pixel.x +  10.0 * pixel.y -  1.0 * deltaTime * frameCounter);"
