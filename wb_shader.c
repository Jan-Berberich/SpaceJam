...
void wbShaderInit(WBShader* shader) {
    ...
    static const char* fragment_shader_src =
        ...
        "    float flicker = 0.3 * sin(200.0 * pixel.x + 300.0 * pixel.y + 30.0 * time)\n"
        "                  + 0.1 * sin(150.0 * pixel.x - 100.0 * pixel.y - 10.0 * time)\n"
        "                  + 0.2 * sin(-50.0 * pixel.x -  30.0 * pixel.y +  5.0 * time)\n"
        "                  - 0.4 * sin(-30.0 * pixel.x +  10.0 * pixel.y -  1.0 * time);\n"
        "    float alpha = texColor.a + flicker;\n"
