...
#define WB_GRAPHIC_TEXT_SCROLL_ANIMATION_COLOR_SPEED (2.0f / 3.0f * 50 / WB_FPS)
#define WB_GRAPHIC_TEXT_MIRROR_ANIMATION_COLOR_SPEED (1.0f / 2.0f * 50 / WB_FPS)
#define WB_GRAPHIC_TEXT_BLINK_ANIMATION_COLOR_SPEED (1.0f / 4.0f * 50 / WB_FPS)
#define WB_GRAPHIC_TEXT_PULSE_ANIMATION_COLOR_SPEED (1.0f / 7.0f * 50 / WB_FPS)
...
#define WB_GRAPHIC_TEXT_TOPSCORES_SHOW_FRAME (920 * WB_FPS / 1000)
#define WB_GRAPHIC_TEXT_HIGHSCORE1_SHOW_FRAME (1940 * WB_FPS / 1000)
#define WB_GRAPHIC_TEXT_HIGHSCORE2_SHOW_FRAME (2260 * WB_FPS / 1000)
#define WB_GRAPHIC_TEXT_SCOREBOARD1_SHOW_FRAME (3390 * WB_FPS / 1000)
#define WB_GRAPHIC_TEXT_SCOREBOARD2_SHOW_FRAME (4040 * WB_FPS / 1000)
#define WB_GRAPHIC_TEXT_SCOREBOARD3_SHOW_FRAME (5240 * WB_FPS / 1000)
#define WB_GRAPHIC_TEXT_SCOREBOARD4_SHOW_FRAME (5260 * WB_FPS / 1000)

// colorpallet (max colors per pallet is 32 in shader)
#define WB_GRAPHIC_COLORPALLET_ENEMY_0 0xFFFFFFFF /* #FFFFFFFF */
#define WB_GRAPHIC_COLORPALLET_ENEMY_1 0xCCD454FF /* #CCD454FF */
#define WB_GRAPHIC_COLORPALLET_ENEMY_2 0x9CE57DFF /* #9CE57DFF */
#define WB_GRAPHIC_COLORPALLET_ENEMY_3 0x616DDDFF /* #616DDDFF */
#define WB_GRAPHIC_COLORPALLET_ENEMY_CNT 4
...
#define WB_GRAPHIC_COLORPALLET_GREEN4_CNT 4
...
#define WB_GRAPHIC_COLORPALLET_BLUE4_CNT 4
...
#define WB_GRAPHIC_COLORPALLET_RED4_CNT 4
// ~GRAPHIC
...
typedef  struct {
    uint32_t red4[WB_GRAPHIC_COLORPALLET_RED4_CNT];
    uint32_t blue4[WB_GRAPHIC_COLORPALLET_BLUE4_CNT];
    uint32_t green4[WB_GRAPHIC_COLORPALLET_GREEN4_CNT];
