...
#define WB_GRAPHIC_GUI_GREEN_ANIMATION_COLOR_0 0x000000FF /* #000000FF */
#define WB_GRAPHIC_GUI_GREEN_ANIMATION_COLOR_1 0x55A33EFF /* #55A33EFF */
#define WB_GRAPHIC_GUI_GREEN_ANIMATION_COLOR_2 0xCED54CFF /* #CED54CFF */
#define WB_GRAPHIC_GUI_GREEN_ANIMATION_COLOR_3 0x99E681FF /* #99E681FF */
#define WB_GRAPHIC_GUI_GREEN_ANIMATION_COLOR_4 0xFFFFFFFF /* #FFFFFFFF */
#define WB_GRAPHIC_GUI_GREEN_ANIMATION_COLOR_5 0x99E681FF /* #99E681FF */
#define WB_GRAPHIC_GUI_GREEN_ANIMATION_COLOR_6 0xCED54CFF /* #CED54CFF */
#define WB_GRAPHIC_GUI_GREEN_ANIMATION_COLOR_7 0x55A33EFF /* #55A33EFF */
#define WB_GRAPHIC_GUI_BLUE_ANIMATION_COLOR_0 0x000000FF /* #000000FF */
#define WB_GRAPHIC_GUI_BLUE_ANIMATION_COLOR_1 0x312BB5FF /* #312BB5FF */
#define WB_GRAPHIC_GUI_BLUE_ANIMATION_COLOR_2 0x8439ACFF /* #8439ACFF */
#define WB_GRAPHIC_GUI_BLUE_ANIMATION_COLOR_3 0x6A65EEFF /* #6A65EEFF */
#define WB_GRAPHIC_GUI_BLUE_ANIMATION_COLOR_4 0xFFFFFFFF /* #FFFFFFFF */
#define WB_GRAPHIC_GUI_BLUE_ANIMATION_COLOR_5 0x6A65EEFF /* #6A65EEFF */
#define WB_GRAPHIC_GUI_BLUE_ANIMATION_COLOR_6 0x8439ACFF /* #8439ACFF */
#define WB_GRAPHIC_GUI_BLUE_ANIMATION_COLOR_7 0x312BB5FF /* #312BB5FF */

#define WB_GRAPHIC_TEXT_ANIMATION_COLOR_SPEED (2.0f / 3.0f * 50 / WB_FPS)
#define WB_GRAPHIC_TEXT_ANIMATION_COLOR_CNT 32
...
#define WB_GRAPHIC_TEXT_TOPSCORES_ANIMATION_COLOR_0 0x000000FF /* #000000FF*/
#define WB_GRAPHIC_TEXT_TOPSCORES_ANIMATION_COLOR_1 0x312BB5FF /* #312BB5FF*/
#define WB_GRAPHIC_TEXT_TOPSCORES_ANIMATION_COLOR_2 0x77BBA2FF /* #77BBA2FF*/
#define WB_GRAPHIC_TEXT_TOPSCORES_ANIMATION_COLOR_3 0x6A65EEFF /* #6A65EEFF*/
#define WB_GRAPHIC_TEXT_TOPSCORES_ANIMATION_COLOR_CNT 4
#define WB_GRAPHIC_TEXT_TOPSCORES_OFFSET_Y 143

#define WB_GRAPHIC_TEXT_DELAY_FRAME_CNT (60.0 * WB_FPS / 1000)
#define WB_GRAPHIC_TEXT_1_FRAME_CNT (3500 * WB_FPS / 1000)
#define WB_GRAPHIC_TEXT_2_FRAME_CNT (4000 * WB_FPS / 1000)
...
#define WB_PLAYER_WIZ_SPRITE_ATLAS_X (0 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PLAYER_WIZ_SPRITE_ATLAS_Y (0 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PLAYER_WIZ_SPAWN_SPRITE_ATLAS_X (0 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PLAYER_WIZ_SPAWN_SPRITE_ATLAS_Y (1 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PLAYER_CAT_SPRITE_ATLAS_X (6 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PLAYER_CAT_SPRITE_ATLAS_Y (2 * WB_GRAPHIC_SPRITE_SIZE)
...
#define WB_PROJECTILE_BEAM_SPRITE_ATLAS_X (10 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_BEAM_SPRITE_ATLAS_Y ( 2 * WB_GRAPHIC_SPRITE_SIZE)
...
#define WB_PROJECTILE_BULLET_SPRITE_ATLAS_X (0 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_BULLET_SPRITE_ATLAS_Y (3 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_BLAZER_SPRITE_ATLAS_X (1 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_BLAZER_SPRITE_ATLAS_Y (3 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_SPRAY_NW_SPRITE_ATLAS_X (2 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_SPRAY_NW_SPRITE_ATLAS_Y (3 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_SPRAY_N_SPRITE_ATLAS_X (3 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_SPRAY_N_SPRITE_ATLAS_Y (3 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_SPRAY_NE_SPRITE_ATLAS_X (4 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_SPRAY_NE_SPRITE_ATLAS_Y (3 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_BLINKER_SPRITE_ATLAS_X (0 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PROJECTILE_BLINKER_SPRITE_ATLAS_Y (4 * WB_GRAPHIC_SPRITE_SIZE)

#define WB_PARTICLE_POWERUP_SPRITE_ATLAS_X (0 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PARTICLE_POWERUP_SPRITE_ATLAS_Y (5 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PARTICLE_DECAY_SPRITE_ATLAS_X (12 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_PARTICLE_DECAY_SPRITE_ATLAS_Y ( 5 * WB_GRAPHIC_SPRITE_SIZE)

#define WB_ENEMY_SPINNERBLUE_SPRITE_ATLAS_X (0 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_ENEMY_SPINNERBLUE_SPRITE_ATLAS_Y (6 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_ENEMY_CIRCLE_SPRITE_ATLAS_X (4 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_ENEMY_CIRCLE_SPRITE_ATLAS_Y (6 * WB_GRAPHIC_SPRITE_SIZE)

#define WB_POWERUP_SPRITE_ATLAS_X ( 0 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_POWERUP_MAXED_SPRITE_ATLAS_X (15 * WB_GRAPHIC_SPRITE_SIZE)
#define WB_POWERUP_SPRITE_ATLAS_Y (14 * WB_GRAPHIC_SPRITE_SIZE)
...
typedef struct {
    uint32_t topscores_animation_colors[WB_GRAPHIC_TEXT_TOPSCORES_ANIMATION_COLOR_CNT];
} WBText;
