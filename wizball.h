...
#define WB_GAMERULE_PLAYER_WIZ_HANDLE_COLLISION_SPEED 60 /*50*/
...
#define WB_GAMERULE_PROCESS_INPUT_TIME (1.0 / WB_GAMERULE_PROCESS_INPUT_SPEED)
#define WB_GAMERULE_PLAYER_WIZ_HANDLE_COLLISION_TIME (1.0 / WB_GAMERULE_PLAYER_WIZ_HANDLE_COLLISION_SPEED)
...
#define WB_GRAPHIC_GUI_POWERUP_MAXED_SPRITE_ATLAS_X (15.0f * WB_GRAPHIC_SPRITE_SIZE)
...
#define WB_GRAPHIC_TEXT_OFFSET_Y                 240.0f
...
#define WB_GRAPHIC_TEXT_GAMEOVER_OFFSET_Y (WB_GRAPHIC_TEXT_OFFSET_Y - 11.0f)
